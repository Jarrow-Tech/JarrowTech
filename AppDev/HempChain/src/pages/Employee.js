...
//selecting company type will be a drop down box
    render(){
      ...
      return(
        ...
        <View style={styles.container}>
         ...
         <Picker style={styles.inputBox} selectedValue={this.state.agency} onValueChange={itemValue => this.setState({agency: itemValue})}>
  ...
  <Picker.Item label="Transporter" value="Trucker" /> 
         ...
         ref={(input)=>this.password=input}
          />
         <TouchableOpacity style={styles.buttonCont} onPress={this.goToPage}>
                  <Text style={styles.buttonText}>
                    Continue
                  </Text>
